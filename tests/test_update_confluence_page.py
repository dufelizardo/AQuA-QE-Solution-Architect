from aqua_qe_solution_architect.skills import update_confluence_page as update_confluence_page_module
from aqua_qe_solution_architect.skills.update_confluence_page import update_confluence_page
...
def test_update_confluence_page_extrai_id_da_url(monkeypatch):
    ...
    update_confluence_page(
        "https://example.atlassian.net/wiki/spaces/AQuAQE/pages/999999/SAD", "# texto"
    )
